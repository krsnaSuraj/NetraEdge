...
notebook = {
 ...
 "cells": [
  ...
  {"cell_type": "code", "metadata": {}, "source": [
   "#@title Step 3: Load LFW Dataset via sklearn\n",
   "from sklearn.datasets import fetch_lfw_people\n",
   "from PIL import Image\n",
   "import numpy as np\n",
   "import os\n",
   "\n",
   "print('Loading LFW via sklearn (downloads automatically)...')\n",
   ...
   "print('Names:', list(lfw.target_names[:5]))\n",
   "\n",
  ...
  {"cell_type": "code", "metadata": {}, "source": [
   ...
   "print('Training complete. Best accuracy: ' + str(round(best_acc, 1)) + '%')"
  ], "outputs": [], "execution_count": None},
  {"cell_type": "code", "metadata": {}, "source": [
   "#@title Step 7: Export to ONNX\n",
   "model.cpu().eval()\n",
   ...
   "print('Download this file and place in F:/PROJECTS/NetraEdge/models/')"
  ], "outputs": [], "execution_count": None}
 ]
}
...
with open(r'F:\PROJECTS\NetraEdge\training\notebooks\train_recognition.ipynb') as f:
    json.load(f)
print('train_recognition.ipynb created and valid!')
