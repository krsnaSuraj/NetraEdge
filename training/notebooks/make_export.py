    ...
    "cells": [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["# Export Trained Model to ONNX\n", "Run this AFTER training is complete."]
        },
        {
            "cell_type": "code",
            "metadata": {},
...
with open(r'F:\PROJECTS\NetraEdge\training\notebooks\export_only.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1)

with open(r'F:\PROJECTS\NetraEdge\training\notebooks\export_only.ipynb') as f:
    json.load(f)
print('export_only.ipynb created and valid!')
